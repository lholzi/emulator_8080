         ...
         case Current_Instruction is
          ...
          ------
           ...
           ------
            ...
            when 16#f6# =>
               Emulator_8080.Processor.ORI_D8(Byte_2    => Processor.Memory(Processor.Program_Counter + 1),
                                              Processor => Processor);
            when 16#f7# =>
               Emulator_8080.Processor.RST_6(Processor => Processor);
            when 16#f8# =>
               Emulator_8080.Processor.RM(Processor => Processor);
            when 16#f9# =>
               Emulator_8080.Processor.SPHL(Processor => Processor);
            when 16#fa# =>
               Emulator_8080.Processor.JM(Byte_2    => Processor.Memory(Processor.Program_Counter + 1),
                                          Byte_3    => Processor.Memory(Processor.Program_Counter + 2),
                                          Processor => Processor);
            when 16#fb# =>
               Emulator_8080.Processor.EI(Processor);
            when 16#fc# =>
               Emulator_8080.Processor.CM(Byte_2    => Processor.Memory(Processor.Program_Counter + 1),
                                          Byte_3    => Processor.Memory(Processor.Program_Counter + 2),
                                          Processor => Processor);
            when 16#fe# =>
